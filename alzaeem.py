...
def main():
	...
	time.sleep(0.09)
	print "   {08} Other tools"
	time.sleep(0.10)
	print "   {09} Root termux\n"
	time.sleep(0.10)
	print "   {10} Exit the alzaeem\n"
	alzaeem = raw_input("alzaeem > ")
	
	if alzaeem == "1" or alzaeem == "01":
		print "\n    {01} Nmap"
		print "    {02} Red Hawk"
		print "    {03} D-Tect"
		print "    {04} sqlmap"
		...
		infogathering = raw_input("alzaeem > ")
	...
	elif alzaeem == "8" or alzaeem == "08":
                print "\n    {01} SpiderBot"
                print "    {02} Ngrok"
                print "    {03} Kali Nethunter"
                print "    {04} VCRT"
                print "    {05} E-Code"
                print "    {06} Termux-Styling"
                print "    {07} PassGen"
                print "    {08} xl-py"
                print "    {09} BeanShell"
                print "    {10} WebConn"
